...
import com.example.firestoredatabase.Model.SpecialCasesIdentifier;
...
public class ConfirmSpecialCasesActivity extends AppCompatActivity {
    ...
    private static SpecialCasesIdentifier casesIdentifier = new SpecialCasesIdentifier();

    public static String centruIntent, judetIntent, nume, sex, telefon, grupa, email, docID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirm_special_cases);
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (varsta < 18 || varsta > 60 || greutate < 50) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(ConfirmSpecialCasesActivity.this);
                                        ...
                                        if (Common.simpleFormatDate.format(c2.getTime()).equals(Common.simpleFormatDate.format(lastDate)) || c2.getTime().after(lastDate)) {
                                            ...
                                            builder.setPositiveButton("DA", new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialogInterface, int i) {
                                                    ...
                                                    Common.docIDPerson = docID;
                                                    Common.getNotifyAllow = true;
                                                    //pentru centru
                                                    casesIdentifier.setTelefon(telefon);
                                                    casesIdentifier.setSex(sex);
                                                    casesIdentifier.setName(nume);
                                                    casesIdentifier.setGrupa(grupa);
                                                    casesIdentifier.setEmail(email);
                                                    casesIdentifier.setCentreId(centruIntent);
                                                    casesIdentifier.setCustomeName(centruIntent);
                                                    casesIdentifier.setTime(Common.converTimeSlotToString(slotNew));
                                                    casesIdentifier.setDate(Common.currentDate.getTime().toString());
                                                    casesIdentifier.setSlot(Long.valueOf(slotNew));
                                                    casesIdentifier.setIdentificator(1);
                                                    casesIdentifier.setDocIDPacient(Common.docIDPerson);
                                                    casesIdentifier.setPatientName(getIntent().getExtras().getString("numePacient"));
                                                    casesIdentifier.setCalendar("da");
                                                        ...
                                                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                if (documentSnapshot.exists()) {
                                                                    Toast.makeText(ConfirmSpecialCasesActivity.this, "Există o rezervare în acest interval!", Toast.LENGTH_LONG).show();
                                                                } else {
                                                                    bookingDate.set(casesIdentifier)
                                                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                @Override
                                                                                public void onSuccess(Void aVoid) {
                                                                                    Toast.makeText(ConfirmSpecialCasesActivity.this, "Rezervare realizată cu succes! Vă mulțumim!", Toast.LENGTH_LONG).show();
                                                                                }
                                                                            }).addOnFailureListener(new OnFailureListener() {
                                                                        @Override
                                                                        public void onFailure(@NonNull Exception e) {
                                                                            Toast.makeText(ConfirmSpecialCasesActivity.this, "Eroare... nu s-a putut efectua rezervarea: " + e.getMessage(), Toast.LENGTH_LONG).show();
                                                                        }
                                                                    });
                                                                    ...
                                                                    DocumentReference updateNoBookings = FirebaseFirestore.getInstance()
                                                                            .collection("specialCases").document(docID);
                                                                ...
                                                                Toast.makeText(ConfirmSpecialCasesActivity.this, "Nu s-a putut face rezervarea. Încercați din nou mai târziu. :)", Toast.LENGTH_LONG).show();
                                                            }
                                                        }
                                                    });
                                                }
                                            ...
                                            builder.setNegativeButton("NU", new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialogInterface, int i) {
                                                    ...
                                                    casesIdentifier.setDocIDPacient(Common.docIDPerson);
                                                    casesIdentifier.setPatientName(getIntent().getExtras().getString("numePacient"));
                                                    casesIdentifier.setCalendar("nu");
                                                            ...
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                if (documentSnapshot.exists()) {
                                                                    ...
                                                                    bookingDate.set(casesIdentifier)
                                                                        ...
                                                                        @Override
                                                                        public void onFailure(@NonNull Exception e) {
                                                                            Toast.makeText(ConfirmSpecialCasesActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                                                                        }
                                                                    });
    ...
    public void addEventCalendar() {
        if (ContextCompat.checkSelfPermission(ConfirmSpecialCasesActivity.this,
                Manifest.permission.WRITE_CALENDAR) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions((Activity) ConfirmSpecialCasesActivity.this,
            ...
            Toast.makeText(ConfirmSpecialCasesActivity.this, beginTime.toString() + endTime.toString(), Toast.LENGTH_LONG).show();
            ...
            if (Build.VERSION.SDK_INT >= 8) {
                ...
                Toast.makeText(ConfirmSpecialCasesActivity.this, "Eveniment adăugat în calendar.", Toast.LENGTH_SHORT).show();
            } else {
                l_eventUri = Uri.parse("content://calendar/events");
                Toast.makeText(ConfirmSpecialCasesActivity.this, "Evenimentul nu a fost adăugat în calendar.", Toast.LENGTH_SHORT).show();
            }
            Uri l_uri = ConfirmSpecialCasesActivity.this.getContentResolver()
            ...
            if (l_uri != null) {
                ...
                Uri r_uri = ConfirmSpecialCasesActivity.this.getContentResolver().insert(reminder_eventUri, reminderValues);
                if (r_uri != null) {
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ConfirmSpecialCasesActivity.this, "Nu s-a permis accesul pentru calendar!", Toast.LENGTH_SHORT).show();
