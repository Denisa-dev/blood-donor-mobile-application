...
public class MyTimeSlotNotificationAdapter extends RecyclerView.Adapter<MyTimeSlotNotificationAdapter.MyViewHolder> {
    ...
    public MyTimeSlotNotificationAdapter(Context context, List<TimeSlot> timeSlotList) {
    ...
    public MyTimeSlotNotificationAdapter(Context context) {
        this.context = context;
