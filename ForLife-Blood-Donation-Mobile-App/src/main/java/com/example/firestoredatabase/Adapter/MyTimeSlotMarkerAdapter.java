...
public class MyTimeSlotMarkerAdapter extends RecyclerView.Adapter<MyTimeSlotMarkerAdapter.MyViewHolder> {
    ...
    public MyTimeSlotMarkerAdapter(Context context, List<TimeSlot> timeSlotList) {
    ...
    public MyTimeSlotMarkerAdapter(Context context) {
        this.context = context;
            ...
            public void onItemSelectedListener(View view, int i) {
                for(CardView cardView:cardViewList)
                {
                    if (holder.card_time_slot.getTag() != Common.DISABLE_TAG && cardView.getTag() == null) {
                        ...
                        Intent intent = new Intent("positionSlot");
