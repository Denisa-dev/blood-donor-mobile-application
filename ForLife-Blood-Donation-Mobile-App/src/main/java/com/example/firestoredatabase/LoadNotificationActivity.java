...
public class LoadNotificationActivity extends AppCompatActivity  implements ITimeSlotLoadListener, DatePickerDialog.OnDateSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(LoadNotificationActivity.this, centru, Toast.LENGTH_LONG).show();
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(LoadNotificationActivity.this, 3);
        recyclerViewSlot.setLayoutManager(gridLayoutManager);
        recyclerViewSlot.addItemDecoration(new SpacesItemDecoration(8));

        iTimeSlotLoadListener = this;
        dialog = new SpotsDialog.Builder().setContext(LoadNotificationActivity.this).setCancelable(false).build();
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(LoadNotificationActivity.this, "Nu ați ales niciun slot.", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    tempPos = slotPosition;
                    slotPosition = null;
                    Intent intent = new Intent(LoadNotificationActivity.this, NotificationBookingActivity.class);
    ...
    private void showDataDialog() {
        ...
        datePickerDialog = DatePickerDialog.newInstance(LoadNotificationActivity.this, Year, Month, Day);
        ...
        centreRef.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful())
                {
                    ...
                    {
                        startActivity(new Intent(LoadNotificationActivity.this, ReservationActivity.class));
                        finish();
                    }
                }
            }
    ...
    public void onTimeSlotLoadSuccess(List<TimeSlot> timeSlotList) {
        MyTimeSlotNotificationAdapter adapter = new MyTimeSlotNotificationAdapter(LoadNotificationActivity.this, timeSlotList);
    ...
    public void onTimeSlotLoadFailed(String message) {
        Toast.makeText(LoadNotificationActivity.this, message, Toast.LENGTH_LONG).show();
        dialog.dismiss();
    }

    @Override
    public void onTimeSlotLoadEmpty() {
        MyTimeSlotNotificationAdapter adapter = new MyTimeSlotNotificationAdapter(LoadNotificationActivity.this);
        recyclerViewSlot.setAdapter(adapter);
         dialog.dismiss();
    }
