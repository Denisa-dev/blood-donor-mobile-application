...
public class MarkerBookingActivity extends AppCompatActivity {
    ...
    private static Integer slotNew, noBooking, varsta, greutate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MarkerBookingActivity.this, FinalMapActivity.class));
                finish();
            }
        });
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (varsta < 18 || varsta > 60 || greutate < 50) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(MarkerBookingActivity.this);
                                                        ...
                                                        public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                                            if (task.isSuccessful()) {
                                                                ...
                                                                if (documentSnapshot.exists()) {
                                                                    Toast.makeText(MarkerBookingActivity.this, "Există o rezervare în acest interval!", Toast.LENGTH_LONG).show();
                                                                } else {
                                                                    bookingDate.set(reservationInfo)
                                                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                @Override
                                                                                public void onSuccess(Void aVoid) {
                                                                                    Toast.makeText(MarkerBookingActivity.this, "Rezervare realizată cu succes! Vă mulțumim!", Toast.LENGTH_LONG).show();
                                                                                }
                                                                            }).addOnFailureListener(new OnFailureListener() {
                                                                        @Override
                                                                        public void onFailure(@NonNull Exception e) {
                                                                            Toast.makeText(MarkerBookingActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                                                                        }
                                                                    });
                                                                ...
                                                                Toast.makeText(MarkerBookingActivity.this, "Nu s-a putut face rezervarea. Încercați din nou mai târziu. :)", Toast.LENGTH_LONG).show();
                                                            }
                                                        }
                                                    });
                                                }
    ...
    public void addEventCalendar() {
        if (ContextCompat.checkSelfPermission(MarkerBookingActivity.this,
                Manifest.permission.WRITE_CALENDAR) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions((Activity) MarkerBookingActivity.this,
            ...
            Toast.makeText(MarkerBookingActivity.this, beginTime.toString() + endTime.toString(), Toast.LENGTH_LONG).show();
            ...
            if (Build.VERSION.SDK_INT >= 8) {
                ...
                Toast.makeText(MarkerBookingActivity.this, "Eveniment adăugat în calendar.", Toast.LENGTH_SHORT).show();
            } else {
                l_eventUri = Uri.parse("content://calendar/events");
                Toast.makeText(MarkerBookingActivity.this, "Evenimentul nu a fost adăugat în calendar.", Toast.LENGTH_SHORT).show();
            }
            Uri l_uri = MarkerBookingActivity.this.getContentResolver()
            ...
            if (l_uri != null) {
                ...
                Uri r_uri = MarkerBookingActivity.this.getContentResolver().insert(reminder_eventUri, reminderValues);
                if (r_uri != null) {
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(MarkerBookingActivity.this, "Nu s-a permis accesul pentru calendar!", Toast.LENGTH_SHORT).show();
